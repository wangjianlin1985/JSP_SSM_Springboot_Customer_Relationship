...
public class DepartmentController extends BaseController {
	...
	public void list(String departmentNo,String departmentName,String bornDate,String fuzeren,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		List<Department> departmentList = departmentService.queryDepartment(departmentNo, departmentName, bornDate, fuzeren, page);
	    /*计算总的页数和总的记录数*/
	    departmentService.queryTotalPageAndRecordNumber(departmentNo, departmentName, bornDate, fuzeren);
	    /*获取到总的页码数目*/
	...
	public String frontlist(String departmentNo,String departmentName,String bornDate,String fuzeren,Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (departmentNo == null) departmentNo = "";
		if (departmentName == null) departmentName = "";
		if (bornDate == null) bornDate = "";
		if (fuzeren == null) fuzeren = "";
		List<Department> departmentList = departmentService.queryDepartment(departmentNo, departmentName, bornDate, fuzeren, currentPage);
	    /*计算总的页数和总的记录数*/
	    departmentService.queryTotalPageAndRecordNumber(departmentNo, departmentName, bornDate, fuzeren);
	    /*获取到总的页码数目*/
	    int totalPage = departmentService.getTotalPage();
	    ...
	    request.setAttribute("departmentNo", departmentNo);
	...
	public void OutToExcel(String departmentNo,String departmentName,String bornDate,String fuzeren, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        if(departmentNo == null) departmentNo = "";
        if(departmentName == null) departmentName = "";
        if(bornDate == null) bornDate = "";
        if(fuzeren == null) fuzeren = "";
        List<Department> departmentList = departmentService.queryDepartment(departmentNo,departmentName,bornDate,fuzeren);
        ...
        for(int i=0;i<departmentList.size();i++) {
        	...
        	dataset.add(new String[]{department.getDepartmentNo(),department.getDepartmentName(),department.getBornDate(),department.getFuzeren()});
        }
        /*
