...
public class DepartmentService {
    ...
    /*按照查询条件分页查询部门记录*/
    public ArrayList<Department> queryDepartment(String departmentNo,String departmentName,String bornDate,String fuzeren,int currentPage) throws Exception { 
    	...
    	if(!fuzeren.equals("")) where = where + " and t_department.fuzeren like '%" + fuzeren + "%'";
    	int startIndex = (currentPage-1) * this.rows;
    	return departmentMapper.queryDepartment(where, startIndex, this.rows);
    }

    /*按照查询条件查询所有记录*/
    public ArrayList<Department> queryDepartment(String departmentNo,String departmentName,String bornDate,String fuzeren) throws Exception  { 
     	String where = "where 1=1";
    	if(!departmentNo.equals("")) where = where + " and t_department.departmentNo like '%" + departmentNo + "%'";
    	if(!departmentName.equals("")) where = where + " and t_department.departmentName like '%" + departmentName + "%'";
    	if(!bornDate.equals("")) where = where + " and t_department.bornDate like '%" + bornDate + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String departmentNo,String departmentName,String bornDate,String fuzeren) throws Exception {
     	String where = "where 1=1";
    	if(!departmentNo.equals("")) where = where + " and t_department.departmentNo like '%" + departmentNo + "%'";
    	if(!departmentName.equals("")) where = where + " and t_department.departmentName like '%" + departmentName + "%'";
    	if(!bornDate.equals("")) where = where + " and t_department.bornDate like '%" + bornDate + "%'";
