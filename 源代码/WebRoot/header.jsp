...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">客户信息网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>Department/frontlist">部门查询</a></li>
                 <!-- 
                <li><a href="<%=basePath %>UserInfo/frontlist">客户</a></li>
                <li><a href="<%=basePath %>Manager/frontlist">管理员</a></li> -->
                
                <li><a href="<%=basePath %>UserCare/frontlist">客户关怀</a></li>
                <li><a href="<%=basePath %>UserEmail/frontlist">客户邮件</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>UserCare/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我收到的关怀</a></li>
                        <li><a href="<%=basePath %>UserEmail/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的邮箱</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_frontUserAdd.jsp"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我要留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的留言</a></li>
