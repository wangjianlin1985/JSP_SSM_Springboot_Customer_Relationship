...
<%
    ...
    String user_name = (String)request.getAttribute("user_name"); //会员名查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>UserInfo/frontlist">客户信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>UserInfo/userInfo_frontAdd.jsp" style="display:none;">添加客户</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<userInfoList.size();i++) {
            		...
            		UserInfo userInfo = userInfoList.get(i); //获取到客户对象
            		String clearLeft = "";
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				...
				<input type="text" id="user_name" name="user_name" value="<%=user_name %>" class="form-control" placeholder="请输入会员名">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="userInfo_user_name_edit" class="col-md-3 text-right">会员名:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="userInfo_user_name_edit" name="userInfo.user_name" class="form-control" placeholder="请输入会员名" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
