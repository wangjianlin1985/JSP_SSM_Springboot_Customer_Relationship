		       ...
		       text: "客户关怀管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "UserCare/userCare_add.jsp"
			    	   	},
			    		{
			    	   		text: "客户关怀管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "UserCare/userCare_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "客户邮件管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "UserEmail/userEmail_add.jsp"
			    	   	},
			    		{
			    	   		text: "客户邮件管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "UserEmail/userEmail_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
		       ...
		       text: "新闻公告管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-edit",
			    		    url: "Manager/manager_selfModify.jsp"
			    	   	}
			    	   ]
			}],
